...
public class AssignHandler {
    ...
    public ResultEntity<String> saveRoleAuthRelationship(@RequestBody Map<String,List<Integer>> map){
        ...
        authSerivce.saveRoleAuthRelationship(map);
    ...
    public ResultEntity<List<Integer>> getAssignedAuthIdByRoleId(@RequestParam("roleId") Integer roleId){
        ...
        List<Integer> authIdList = authSerivce.getAssignedAuthIdByRoleId(roleId);
    ...
    public ResultEntity<List<Auth>> getAllAuth(){
        ...
        List<Auth> authList = authSerivce.getAll();
    ...
    public String saveAdminRoleRelationship(
            ...
            // 我们允许用户在页面上取消已分配角色再提交表单，所以可以不提供roleIdList请求参数
